...
require 'digest'
require 'tempfile'
require 'paperclip/paperclip/version'
require 'paperclip/paperclip/upfile'
require 'paperclip/paperclip/iostream'
require 'paperclip/paperclip/geometry'
require 'paperclip/paperclip/processor'
require 'paperclip/paperclip/thumbnail'
require 'paperclip/paperclip/interpolations'
require 'paperclip/paperclip/style'
require 'paperclip/paperclip/attachment'
require 'paperclip/paperclip/attachment_options'
require 'paperclip/paperclip/storage'
require 'paperclip/paperclip/callback_compatibility'
require 'paperclip/paperclip/missing_attachment_styles'
require 'paperclip/paperclip/railtie'
require 'logger'
require 'cocaine'
